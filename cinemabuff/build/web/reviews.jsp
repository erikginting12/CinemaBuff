<%-- 
    Document   : reviews
    Created on : 01-Nov-2018, 16:12:23
    Author     : Alexander
--%>
	...
	<div class="full">
		...
		<div class="review-content">
			...
			<div class="reviews-section">
				<h3 class="head">Movie Reviews</h3>
					<div class="col-md-9 reviews-grids">
						<div class="review">
							...
							<div class="review-info">
								<a class="span" href="single.jsp">Lorem  <i>Movie Review</i></a>
					...
					<div class="col-md-3 side-bar">
						<div class="featured">
							...
							<ul>
								<li>
									<a href="single.jsp"><img src="images/f1.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.jsp"><img src="images/f2.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.jsp"><img src="images/f3.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.jsp"><img src="images/f4.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.jsp"><img src="images/f5.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.jsp"><img src="images/f6.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<div class="clearfix"></div>
							</ul>
						...
						<div class="entertainment">
							...
							<ul>
								...
								<li>
									<a href="single.jsp">Watch ‘Bombay Velvet’ trailer during WC match</a>
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.jsp"><img src="images/mi.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.jsp">Lorem Ipsum <i> </i></a>
					</div>
				<div class="clearfix"></div>
				</div>
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.jsp"><img src="images/mi1.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.jsp">Lorem Ipsum <i> </i></a>
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.jsp"><img src="images/mi2.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.jsp">Lorem Ipsum <i> </i></a>
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.jsp"><img src="images/mi3.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.jsp">Lorem Ipsum <i> </i></a>
			...
			<!---->
				...
				<h4>Archives</h4>
				<ul>
					<li><a href="single.jsp">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </a></li>
					<li><a href="single.jsp">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</a></li>
					<li><a href="single.jsp">When an unknown printer took a galley of type and scrambled it to make a type specimen book. </a> </li>
					<li><a href="single.jsp">It has survived not only five centuries, but also the leap into electronic typesetting</a> </li>
					<li><a href="single.jsp">Remaining essentially unchanged. It was popularised in the 1960s with the release of </a> </li>
					<li><a href="single.jsp">Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing </a> </li>
					<li><a href="single.jsp">Software like Aldus PageMaker including versionsof Lorem Ipsum.</a> </li>
				</ul>
				</div>
				<!---->
